...
<div align="center">
  <img src="./assets/generated/mission-telemetry.svg" width="850" alt="Mission Telemetry"/>
</div>
...
- [ai-programming-harness-meeting-2026-05-19](https://github.com/siuserxiaowei/ai-programming-harness-meeting-2026-05-19) `JavaScript` `archive`
  - 中文：AI 编程 Harness 会议：围绕 Codex / Claude Code / agent workflow / testing 的项目。
  - English: ai-programming-harness-meeting-2026-05-19 for ai-programming-harness-meeting-2026-05-19 for Codex, Claude Code, agent workflow, testing.
- [aliyun-ai-partner-qoder-2026-05-21](https://github.com/siuserxiaowei/aliyun-ai-partner-qoder-2026-05-21) `archive`
  - 中文：阿里云 AI Partner/Qoder 会议资料：沉淀 AI 编程、云服务和开发者工具的会议记录。
  - English: Aliyun AI Partner/Qoder meeting archive covering AI coding, cloud AI, and developer tools.
- [codex-app-meeting-report](https://github.com/siuserxiaowei/codex-app-meeting-report) `archive`
  - 中文：Codex App 会议报告：围绕 meeting report / AI summary / PDF workflow 的项目。
  - English: codex-app-meeting-report for codex-app-meeting-report for meeting report, AI summary, PDF workflow.
- [guangzhou-founder-roundtable-2026](https://github.com/siuserxiaowei/guangzhou-founder-roundtable-2026) `HTML` `archive`
  - 中文：广州创业者圆桌：围绕 AI startup / founder roundtable / startup ecosystem 的项目。
  - English: guangzhou-founder-roundtable-2026 for guangzhou-founder-roundtable-2026 for AI startup, founder roundtable, startup ecosystem.
- [ios-ai-app-dev-meeting-2026-05-17](https://github.com/siuserxiaowei/ios-ai-app-dev-meeting-2026-05-17) `archive`
  - 中文：iOS AI 应用开发会议：围绕 mobile AI / app development / Swift 的项目。
  - English: ios-ai-app-dev-meeting-2026-05-17 for ios-ai-app-dev-meeting-2026-05-17 for mobile AI, app development, Swift.
- [miaoji-s-meeting-minutes-wiki-2026](https://github.com/siuserxiaowei/miaoji-s-meeting-minutes-wiki-2026) `HTML` `archive`
  - 中文：妙记+S 会议纪要 Wiki：把会议记录整理成可浏览、可复盘的 GitHub Pages 知识站。
  - English: Miaoji+S meeting minutes wiki for browsing and reviewing meeting knowledge on GitHub Pages.
- [scai-meeting-minutes-wiki-2026](https://github.com/siuserxiaowei/scai-meeting-minutes-wiki-2026) `HTML` `archive`
...
**关键词 / Keywords**: GitHub Profile README, AI portfolio, personal branding, SVG dashboard, AI tools, AI automation, GitHub Pages, SEO
